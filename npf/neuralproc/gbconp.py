...
class ConvCNP(NeuralProcessFamily):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.encoded_path = kwargs["encoded_path"]
...
class GlobalConvNP(LatentNeuralProcessFamily, ConvCNP):
    """
    ...
    def infer_latent_dist(self, X, R):
        ...
        q_z_suffstat = q_z_suffstat.mean(dim=-2, keepdim=True)
    ...
    def trgt_dependent_representation(self, X_cntxt, z_samples, R_induced, X_trgt):
        ...
        z_samples = self.decoder_CNN(z_samples)
